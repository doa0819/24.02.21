...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   super : 자석클래스를 이용해서 객체를 생성할 때 부모 생성자를 호출해서
        *           부모 클래스의 인스턴스도 함께 생성하게 된다.
        *           이 때 부모의 인스턴스 주소를 보관하는 래퍼런스변수로
        ...
        *           private 생성자를 제외한 나머지 생성자를 호출할 수 있다.*/
        ...
        // Product 기본 생성자로 인스턴스 생성 후 정보 풀력
        Product product1 = new Product();
        System.out.println(product1.getInfo());


        // Product 모든 필드 초기화 하는 생성자
        Product product2 = new Product("A-1230", "삼송", "걘역시S2", 20000,new java.util.Date());
        ...
        //Computer 부모필드 까지 전부 초기화하는
        Computer computer3 = new Computer("A-1234","삼송","걘역시2",2000,new java.util.Date()
                ,"19", 512,32,"윈도우");
